<template>
  <svg viewBox="0 0 1400 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="base" ref="Ref_base" @mousedown="onBtnDown" @mouseup="onBtnUp">
...
import MorphSVGPlugin from '@/lib/js/MorphSVGPlugin3.min'
...
export default {
  ...
  methods: {
    ...
    onBtnUp() {
      ...
      this.ranOnce = true;
      this.tl.to("#base", { duration: 0.2, scale: 1, transformOrigin: "50% 50%" });
      this.tl.to(
        "#btnBase",
      ...
      this.tl.to("#btnBase", { duration: 0.23, morphSVG: "#cTop", ease: "power1.inOut" });
      this.tl.to("#btnBase", {
        duration: 0.2,
        morphSVG: "#cCenter",
        ease: "power1.inOut"
      ...
      this.tl.to("#rectSentItems", { x: "0", duration: 0.5 }, "revealStart");
      this.tl.to(
        "#mask1",
